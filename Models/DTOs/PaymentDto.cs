...
namespace stibe.api.Models.DTOs
{
    ...
    public class UpiPaymentRequestDto
    {
        ...
        [Required]
        [StringLength(50)]
        public string UpiId { get; set; } = string.Empty; // pa (Payment Address)
        
        [Required]
        [StringLength(100)]
        public string PayeeName { get; set; } = string.Empty; // pn (Payee Name)
        ...
        [StringLength(50)]
        public string? TransactionRef { get; set; } // tr (Transaction Reference)
    }
